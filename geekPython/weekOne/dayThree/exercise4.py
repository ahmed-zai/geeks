...
class Zoo():
    ...
    def sort_animals(self):
        self.animals.sort()
        self.groubed_animals = {}
        for animal in self.animals:
            first_letter = animal[0].upper()
            if first_letter not in self.groubed_animals:
                self.groubed_animals[first_letter] = []
            self.groubed_animals[first_letter].append(animal)
        return self.groubed_animals
    ...
    def get_groups(self):
        for letter, animals in self.groubed_animals.items():
